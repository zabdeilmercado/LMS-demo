                    ...
                    <CardContent>
                      <form className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input id="program" defaultValue="Bachelor of Science in Information Technology" disabled />
                        </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center">
                          <input type="checkbox" id="activity-status" className="h-4 w-4 rounded border-gray-300" />
                        </div>
                      </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        <input type="checkbox" id="email-discussions" className="h-4 w-4 rounded border-gray-300" />
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Receive emails about system maintenance and updates</p>
                      </div>
                      <div className="flex items-center">
